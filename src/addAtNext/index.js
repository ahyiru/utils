...
const addAtNext = (tree, id, nodes, idKey = "id", childKey = "children") => (0,_selectedHandle__WEBPACK_IMPORTED_MODULE_0__["default"])((data, index) => data.splice(index, 0, nodes))(tree, id, idKey, childKey);
