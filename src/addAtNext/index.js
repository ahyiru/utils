...
const addAtNext = (tree, id, nodes, idKey = "id", childKey = "children") => (0,_selectedHandle__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A)((data, index) => data.splice(index, 0, nodes))(tree, id, idKey, childKey);
/* harmony default export */ __webpack_exports__.A = (addAtNext);
