...
const updateId = (tree, idKey = "fuckId", childKey = "children") => (0,_traverItem__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A)((item, parent, index) => {
  item[idKey] = [...parent.map((v) => v["@@index"]), index].join("-");
})(tree, childKey);
/* harmony default export */ __webpack_exports__.A = (updateId);
