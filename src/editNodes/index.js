...
!function() {
/* harmony import */ var _selectedHandle__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(9342);

const editNodes = (tree, id, nodes, idKey = "id", childKey = "children") => (0,_selectedHandle__WEBPACK_IMPORTED_MODULE_0__["default"])((data, index) => data[index] = { ...data[index], ...nodes })(tree, id, idKey, childKey);
/* harmony default export */ __webpack_exports__["default"] = (editNodes);
