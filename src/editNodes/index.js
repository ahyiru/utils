...
const editNodes = (tree, id, nodes, idKey = "id", childKey = "children") => (0,_selectedHandle__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A)((data, index) => data[index] = { ...data[index], ...nodes })(tree, id, idKey, childKey);
/* harmony default export */ __webpack_exports__.A = (editNodes);
