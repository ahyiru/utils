...
const addNodes = (tree, id, nodes, idKey = "id", childKey = "children") => (0,_selectedHandle__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z)((data, index) => {
  const item = data[index];
  item[childKey] = [...item[childKey] || [], ...nodes];
  return item;
})(tree, id, idKey, childKey);
/* harmony default export */ __webpack_exports__.Z = (addNodes);
