...
/* harmony import */ var _getPosition__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(2217);
/* harmony import */ var _setStyle__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(9433);
/* harmony import */ var _isRef__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(8427);
/* harmony import */ var _isElement__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(9622);
/* harmony import */ var _sleep__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(9941);
...
const getElementsSize = async (ele, delay = 15) => {
  ...
  ele = (0,_isRef__WEBPACK_IMPORTED_MODULE_4__/* ["default"] */ .A)(ele) ? ele.current : ele;
  if (!(0,_isElement__WEBPACK_IMPORTED_MODULE_5__/* ["default"] */ .A)(ele)) {
    return {};
  }
  const shadow = ele.cloneNode(true);
  (0,_setStyle__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .A)(shadow, { "pointer-events": "none", "z-index": -1, opacity: 0, display: "block", animation: "none" });
  ele.parentNode.appendChild(shadow);
  await (0,_sleep__WEBPACK_IMPORTED_MODULE_6__/* ["default"] */ .A)(delay);
  const info = (0,_getPosition__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .A)(shadow);
...
/* harmony export */ });
/* harmony import */ var _debounce__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(9195);
/* harmony import */ var _getViewportSize__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(8081);
/* harmony import */ var _getPosition__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(2217);
/* harmony import */ var _getElementsSize__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(2050);
...
const setPosition = async (triggerEle, showEle, type) => {
  const { left, right, top, bottom } = (0,_getPosition__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .A)(triggerEle);
  const { width, height } = (0,_getViewportSize__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A)();
  const { width: sWidth, height: sHeight } = await (0,_getElementsSize__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .A)(showEle);
  ...
  if (type === "vertical") {
    ...
    (0,_setStyle__WEBPACK_IMPORTED_MODULE_4__/* ["default"] */ .A)(showEle, style);
...
const dropInfo = (triggerEle, showEle, type = "horizontal") => {
  const debounced = (0,_debounce__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A)(setPosition);
  ...
  const destroyFn = () => {
    ...
    (0,_setStyle__WEBPACK_IMPORTED_MODULE_4__/* ["default"] */ .A)(showEle, { left: "", top: "", right: "", bottom: "" });
  };
