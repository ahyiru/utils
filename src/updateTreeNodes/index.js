...
const updateTreeNodes = (tree, id, nodes, childKey = "children") => (0,_selectedHandle__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z)((data, index) => {
  const item = data[index];
  item[childKey] = [...item[childKey] || [], ...nodes];
  return true;
})(tree, id);
/* harmony default export */ __webpack_exports__.Z = (updateTreeNodes);
