...
const deleteNodes = (tree, id, idKey = "id", childKey = "children") => (0,_selectedHandle__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z)((data, index) => data.splice(index, 1))(tree, id, idKey, childKey);
/* harmony default export */ __webpack_exports__.Z = (deleteNodes);
